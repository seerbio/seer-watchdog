...
python E:\git\seer-watchdog\seer_watchdog.py --aws_access_key_id "AKIA4MTWK5PNTTEU2SVC" --aws_secret_access_key "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" --aws-region us-west-2 --source "%sourceDir%" --bucket seer-de-test-bucket --instrument Bruker --destination S3 --log_group ms_data_log_group --log_stream ms_data_log_stream >> %watchdog_batch_script_log% 2>&1
